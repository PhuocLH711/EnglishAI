...
public class ChatMessageAdapter
    ...
    public void onBindViewHolder(
        ...
        if (holder instanceof UserMessageViewHolder) {
            ...
            UserMessageViewHolder userHolder =
            ...
            userHolder.tvMessage.setVisibility(
            ...
            if (userHolder.imgMessage != null) {

                if (hasImage) {
                    try {
                        userHolder.imgMessage.setImageURI(
                                Uri.parse(imageUri)
                        );
                        userHolder.imgMessage.setVisibility(
                                View.VISIBLE
                        );
                    } catch (Exception exception) {
                        userHolder.imgMessage.setImageDrawable(null);
                        userHolder.imgMessage.setVisibility(View.GONE);
                    }
                } else {
                    userHolder.imgMessage.setImageDrawable(null);
                    userHolder.imgMessage.setVisibility(View.GONE);
