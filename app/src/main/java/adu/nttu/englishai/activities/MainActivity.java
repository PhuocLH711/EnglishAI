...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Kích hoạt tính năng kéo thả linh hoạt cho bong bóng AI Tutor
        setupDraggableAiTutor();

        // Ánh xạ và xử lý thanh điều hướng Bottom Navigation bên dưới
        ...
        // Mặc định hiển thị Trang chủ khi vừa mở ứng dụng lần đầu
